...
SdpSimplified processSdp(SdpSimplified sdp, bool isOffer) {
  // 0 Separate offers and answers:
  if (isOffer) {
    // work with sdp from offers

  var allowedAudioCodecs = ['PCMA', 'opus'];
...
//        'level-asymmetry-allowed=1;packetization-mode=1;profile-level-id=428016';
//    newVideoCodec.shouldOverrideEmptyFmtp = true;
